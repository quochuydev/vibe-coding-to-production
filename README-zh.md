...
<img width="100%" src="./images/nextjs-local-preview.png" alt="Next.js 本地预览" />
...
<img width="100%" src="./images/stripe-api-keys.png" alt="Stripe API 密钥" />
...
<img width="100%" src="./images/stripe-test-payment.png" alt="Stripe 测试支付" />
...
<img width="100%" src="./images/digitalocean-create-droplet.png" alt="DigitalOcean 创建 Droplet" />
...
<img width="100%" src="./images/dokploy-setup-screen.png" alt="Dokploy 设置界面" />
...
<img width="100%" src="./images/dokploy-github-connection.png" alt="Dokploy GitHub 连接" />
...
<img width="100%" src="./images/dokploy-deploy-logs.png" alt="Dokploy 部署日志" />
